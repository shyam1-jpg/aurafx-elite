/** Country list for client registration (ISO-style codes) */
window.AURAFX_COUNTRIES = [
  ...
  { code: "KR", name: "Korea (South)" }, { code: "XK", name: "Kosovo" }, { code: "KW", name: "Kuwait" },
  ...
  { code: "ZM", name: "Zambia" }, { code: "ZW", name: "Zimbabwe" }, { code: "GI", name: "Gibraltar" },
